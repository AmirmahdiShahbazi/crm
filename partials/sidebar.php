          ...
          <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
              <ul class="sidebar-links" id="simple-bar">
                ...
                <li class="sidebar-list">
                  <a class="sidebar-link sidebar-title" href="#">
                    <i class="fa fa-user" style="font-size:20px; margin-left:12px;"></i><span>کارشناس ها</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="../experts/index.php">لیست کارشناس ها</a></li>
                    <li><a href="../experts/create.php">ایجاد کارشناس جدید</a></li>
                  </ul>
                </li>
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <i class="fa fa-book ml-3" style="font-size:20px; margin-left:12px;"></i><span>پرونده ها</span></a>
                  <ul class="sidebar-submenu">
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="../requirements/index.php">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                    ...
                    </svg><span>نیازمندی ها</span></a></li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="./../tasks/index.php">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                  ...
                  <ul class="sidebar-submenu">
                    <li><a class="submenu-title" href="#">کنترل های فرم<span class="sub-arrow"><i class="fa fa-angle-left"></i></span></a>
                    ...
                    <li><a class="submenu-title" href="#">ویجت های فرم<span class="sub-arrow"><i class="fa fa-angle-left"></i></span></a>
                      <ul class="nav-sub-childmenu submenu-content">
                    ...
                    <li><a class="submenu-title" href="#">لایه فرم<span class="sub-arrow"><i class="fa fa-angle-left"></i></span></a>
                      <ul class="nav-sub-childmenu submenu-content">
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                  ...
                  <ul class="sidebar-submenu">
                    <li><a class="submenu-title" href="#">جداول بوت استرپ<span class="sub-arrow"><i class="fa fa-angle-left"></i></span></a>
                      <ul class="nav-sub-childmenu submenu-content">
                    ...
                    <li><a class="submenu-title" href="#">جداول داده<span class="sub-arrow"><i class="fa fa-angle-left"></i></span></a>
                      <ul class="nav-sub-childmenu submenu-content">
                    ...
                    <li><a class="submenu-title" href="#">افزونه های جداول داده<span class="sub-arrow"><i class="fa fa-angle-left"></i></span></a>
                      <ul class="nav-sub-childmenu submenu-content">
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                  ...
                  <ul class="sidebar-submenu">
                    ...
                    <li><a class="submenu-title" href="#">تب ها<span class="sub-arrow"><i class="fa fa-angle-left"></i></span></a>
                      <ul class="nav-sub-childmenu submenu-content">
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                  ...
                  <ul class="sidebar-submenu">
                    ...
                    <li><a class="submenu-title" href="#">تایم لاین<span class="sub-arrow"><i class="fa fa-angle-left"></i></span></a>
                      <ul class="nav-sub-childmenu submenu-content">
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="../starter-kit/index-kit.html" target="_blank">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
