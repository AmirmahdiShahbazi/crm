  ...
  <div class="header-wrapper row m-0">
    ...
    <div class="left-side-header col ps-0 d-none d-md-block">
      <div class="input-group"><span class="input-group-text" id="basic-addon1">
        ...
        <input class="form-control" type="text" placeholder="اینجا جستجو کنید ..." aria-label="search" aria-describedby="basic-addon1">
      </div>
          ...
          <div class="cart-dropdown onhover-show-div">
            ...
            <ul class="custom-scrollbar">
              ...
              <li class="order-total">
                <h4 class="mb-0 f-w-700">مجموع : <span>1,500,000 ت</span></h4><a class="btn btn-primary view-checkout" href="checkout.html">پرداخت</a>
              </li>
            </ul>
          </div>
        </li>
              ...
              <div class="flip-card-inner">
                <div class="front dropdown-title">
                  ...
                  <ul class="bookmark-dropdown pb-0">
                    ...
                    <li class="text-center"><a class="flip-btn btn btn-primary" id="flip-btn" href="javascript:void(0)">افزودن نشانک جدید</a></li>
                  </ul>
                </div>
