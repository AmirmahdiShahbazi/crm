(function (e) {
        ...
        action: function (a, b, d, c) {
            ...
            if (l.queryCommandSupported("copy")) {
                ...
                try {
                    ...
                    d.remove();
                    if (k) {
                        b.buttons.info(b.i18n("buttons.copyTitle", "کپی در کلیپ بورد"), b.i18n("buttons.copySuccess", {
                            1: "یک ردیف در کلیپ بورد کپی شد",
                            _: "%d ردیف در کلیپ بورد کپی شد"
                        }, a.rows), 2E3);
                        this.processing(!1);
                        return
                    }
            ...
            k = e("<span>" + b.i18n("buttons.copyKeys", "دکمه <i>ctrl</i> یا <i>âŒ˜</i> + <i>C</i> را برای کپی داده های جدول<br>در کلیپ بورد سیستم خود فشار دهید<br><br>برای لغو روی این پیام کلیک کنید یا دکمه escape را فشار دهید") +
                "</span>").append(d);
            b.buttons.info(b.i18n("buttons.copyTitle", "کپی در کلیپ بورد"), k, 0);
            c[0].focus();
            c[0].select();
    ...
    p.ext.buttons.csvHtml5 = {
        ...
        text: function (a) {
            return a.i18n("buttons.csv", "خروجی CSV")
        },
        action: function (a, b, d, c) {
            this.processing(!0);
            a = G(b, c).str;
    ...
    p.ext.buttons.excelHtml5 = {
        ...
        text: function (a) {
            return a.i18n("buttons.excel", "خروجی اکسل")
        },
        action: function (a, b, d, c) {
            this.processing(!0);
            var f = this,
    ...
    p.ext.buttons.pdfHtml5 = {
        ...
        text: function (a) {
            return a.i18n("buttons.pdf", "خروجی PDF")
        },
        action: function (a, b, d, c) {
            this.processing(!0);
