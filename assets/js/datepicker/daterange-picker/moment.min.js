...
! function (a, b) {
    ...
    var Vd = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,
        Wd = "ژانویه_فوریه_مارچ_آپریل_مه_ژوئن_جولای_آگوست_سپتامبر_اکتبر_نوامبر_دسامبر".split("_"),
        Xd = "ژانویه_فوریه_مارچ_آپریل_مه_ژوئن_جولای_آگوست_سپتامبر_اکتبر_نوامبر_دسامبر".split("_"),
        Yd = Jd,
        Zd = Jd,
    ...
    var qe = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنج شنبه_جمعه_شنبه".split("_"),
        re = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنج شنبه_جمعه_شنبه".split("_"),
        se = "یک_دو_سه_چه_پن_جم_شن".split("_"),
        te = Jd,
        ue = Jd,
        ve = Jd;
