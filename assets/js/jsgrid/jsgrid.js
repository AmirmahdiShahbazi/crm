(function($) {
    ...
    $("#basicScenario").jsGrid({
        ...
        pageSize: 15,
        pageButtonCount: 5,
        deleteConfirm: "آیا شما برای حذف این مورد مطمئن هستید؟",
        controller: db,
        fields: [
        { name: "نام", type: "text", width: 150 },
        { name: "سن", type: "number", width: 50 },
        { name: "آدرس", type: "text", width: 200 },
        { name: "استان", type: "select", items: db.countries, valueField: "Id", textField: "Name" },
        { name: "وضعیت تأهل", type: "checkbox", title: "متأهل", sorting: false },
        { type: "control" }
        ]
    });
    $("#sorting-table").jsGrid({
        ...
        { name: "آدرس", type: "text", width: 200 },
        { name: "استان", type: "select", items: db.countries, valueField: "Id", textField: "Name" },
        { name: "وضعیت تأهل", type: "checkbox", title: "متأهل" }
        ]
    });
    $("#sort").click ( function() {
