...
(function (global, factory) {
  ...
  $$1.extend($$1.summernote.lang, {
    "en-US": {
      ...
      image: {
        ...
        shapeRounded: "شکل : دور گرد",
        shapeCircle: "شکل : گرد",
        shapeThumbnail: "شکل : بندانگشتی",
        shapeNone: "شکل : هیچ",
        dragImageHere: "تصویر یا متن را اینجا بکشید",
        dropImage: "رها کردن متن یا تصویر",
        selectFromFiles: "انتخاب از فایل ها",
        maximumFileSize: "حداکثر اندازه فایل",
        maximumFileSizeError: "از حداکثر اندازه فایل بیشتر شد",
        url: "آدرس URL تصویر",
        remove: "حذف تصویر",
        original: "اورجینال",
      },
      video: {
        ...
        insert: "قرار دادن ویدئو",
        url: "آدرس URL ویدئو",
        providers: "(یوتیوب, ویمئو, واین, اینستاگرام)",
      },
      link: {
        link: "لینک",
        insert: "قرار دادن لینک",
        unlink: "حذف لینک",
        edit: "ویرایش",
        textToDisplay: "متن برای نمایش",
        url: "این لینک باید به کدام آدرس اینترنتی برود؟",
        openInNewWindow: "باز شدن در پنجره جدید",
      },
      table: {
        table: "جدول",
        addRowAbove: "اضافه کردن ردیف بالا",
        addRowBelow: "اضافه کردن ردیف زیر",
      ...
      lists: {
        unordered: "لیست غیرترتیبی",
        ordered: "لیست ترتیبی",
      },
      options: {
        help: "راهنما",
        fullscreen: "فول اسکرین",
        codeview: "نمایش کد",
      },
      paragraph: {
        paragraph: "پاراگراف",
      ...
      color: {
        ...
        transparent: "شفاف",
        setTransparent: "ست کردن رنگ والد",
        reset: "بازنشانی",
        resetToDefault: "رنگ پیش فرض",
      },
      shortcut: {
        shortcuts: "کدهای کوتاه کیبورد",
        close: "بستن",
        textFormatting: "فرمت متن",
        action: "عمل",
        paragraphFormatting: "فرمت پاراگراف",
        documentStyle: "مستندات استایل",
        extraKeys: "کلیدهای اضافی",
      },
      help: {
        insertParagraph: "قراردادن پاراگراف",
        undo: "آخرین دستور را لغو می کند",
        redo: "آخرین دستور را دوباره انجام می دهد",
        tab: "زبانه",
        untab: "حذف زبانه",
        bold: "یک استایل بولد تنظیم کنید",
        italic: "یک استایل ایتالیک تنظیم کنید",
        underline: "یک استایل خط زیر تنظیم کنید",
        strikethrough: "یک استایل خط خورده تنظیم کنید",
        removeFormat: "پاک کردن یک استایل",
        justifyLeft: "تنظیم تراز چپ",
        justifyCenter: "تنظیم تراز وسط",
        justifyRight: "تنظیم تراز راست",
        justifyFull: "تنظیم هم ترازی",
        insertUnorderedList: "فهرست نامرتب را تغییر دهید",
        insertOrderedList: "فهرست مرتب را تغییر دهید",
        outdent: "بیرون زدگی روی پاراگراف فعلی",
        ...
        insertHorizontalRule: "درج خط افقی",
        "linkDialog.show": "نمایش گفتگوی پیوند",
      },
      history: {
        undo: "واچیدن",
        redo: "بازچیدن",
      ...
      specialChar: {
        specialChar: "کارکترهای مخصوص",
        select: "انتخاب کاراکترهای مخصوص",
      },
    },
  });
  ...
  var HelpDialog = /** @class */ (function () {
    ...
    HelpDialog.prototype.initialize = function () {
      ...
      var body = [
        '<p class="text-center">',
        '<a href="http://summernote.org/" target="_blank">ویرایشگر Summernote 0.8.10</a> · ',
        '<a href="https://github.com/summernote/summernote" target="_blank">پروژه</a> · ',
        '<a href="https://github.com/summernote/summernote/issues" target="_blank">مسائل</a>',
        "</p>",
      ].join("");
      this.$dialog = this.ui
        .dialog({
