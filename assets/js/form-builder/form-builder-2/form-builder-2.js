$(document).ready(function () {
  ...
  $("#copy-to-clipboard").on("click", function () {
    ...
    $modal.find(".modal-title").html("کپی کد HTML");
    ...
    .droppable({
      ...
      drop: function (event, ui) {
        ...
        if (!$(ui.draggable).hasClass("dropped")) {
          ...
          $(
            '<p class="tools">\
						<a class="edit-link">ویرایش HTML<a> | \
						<a class="remove-link">حذف</a></p>'
          ).appendTo($el);
        } else {
    ...
    '<div class="modal" style="overflow: auto;" tabindex="-1">\
			<div class="modal-dialog">\
				<div class="modal-content">\
					...
					<h4 class="modal-title">ویرایش HTML</h4>\
      ...
      content +
      '</textarea>\
						<button class="btn btn-light btn-square">به روز رسانی</button>\
					</div>\
				</div>\
			</div>\
			</div>'
