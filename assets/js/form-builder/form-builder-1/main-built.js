...
+(function (e) {
  ...
  define("text!templates/app/tab-nav.html", [], function () {
    return '<li><a href="#<%= id %>" data-toggle="tab"><%= value %></a></li>\n';
  }),
  define(
    "views/tab",
