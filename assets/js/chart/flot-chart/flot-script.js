...
if ($("#annotations-chart").length > 0) {
    for (var a = [], b = 0; b < 20; ++b) a.push([b, Math.sin(b)]);
        ...
        e.append("<div style='position:absolute;left:" + (g.left + 4) + "px;top:" + g.top + "px;color:#666;font-size:smaller'>گرم شدن</div>"), g = f.pointOffset({
            x: 8,
            y: -1.2
        }), e.append("<div style='position:absolute;left:" + (g.left + 4) + "px;top:" + g.top + "px;color:#666;font-size:smaller'>اندازه گیری های واقعی</div>");
        ...
        function plotAccordingToChoices() {
            ...
            if (data.length > 0) {
                $.plot("#toggling-series-flot", data, {
                    ...
                    colors: [zetaAdminConfig.primary, "#f8d62b" ,"#a927f9" ,"#51bb25" , zetaAdminConfig.secondary , "#dc3545" ,"#f8d62b"]
...
$(function() {
    ...
    var data4_errors = [0.1, 0.4, 0.2];
        ...
        var data = [
            {color: "#f73164", points: data1_points, data: data1, label: "داده 1"},
            {color: "#a927f9",  points: data2_points, data: data2, label: "داده 2"},
            {color: "#f8d62b", lines: {show: true}, points: data3_points, data: data3, label: "داده 3"},
            {color: "#7366ff", bars: {show: true, align: "center", barWidth: 0.25}, data: data4, label: "داده 4"},
...
$(function() {
    ...
    $.plot('#default-pie-flot-chart', data, {
        ...
        colors: [ zetaAdminConfig.primary , "#51bb25" ,"#f8d62b" ,"#a927f9" ,"#dc3545", "#6c757d" , zetaAdminConfig.secondary ]
    });
