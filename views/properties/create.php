...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" enctype="multipart/form-data" action="../../properties/create.php" class="theme-form">
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="radio" class="property_type" name="property_type" value="آپارتمان">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="radio" class="property_type" name="property_type" value="ویلا">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="radio" class="property_type" name="property_type" value="خانه حیاط دار">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="radio" class="property_type" name="property_type" value="زمین">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="radio" class="property_type" name="property_type" value="دفتر کار">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="radio" class="property_type" name="property_type" value="مغازه">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="radio" class="property_type" name="property_type" value="مستغلات">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="radio" class="property_type" name="property_type" value="کلنگی">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="radio" class="property_type" name="property_type" value="انبار">
                ...
                <div class="mb-3 row feature hidden shop">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" id="Website" type="text" name="shop_size" placeholder="متراژ زمین (متر مربع)">
                    </div>
                </div>
                ...
                <div class="mb-3 row feature hidden land pick">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="checkbox" name="land_type" value="مسکونی">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="checkbox" name="land_type" value="تجاری">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="checkbox" name="land_type" value="باغ">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="checkbox" name="land_type" value="خدماتی">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="checkbox" name="land_type" value="فرهنگی">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="checkbox" name="land_type" value="مزروعی">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="checkbox" name="land_type" value="صنعتی">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="checkbox" name="land_type" value="شهری">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="checkbox" name="land_type" value="شهرکی">
                ...
                <div class="mb-3 row feature hidden land">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="checkbox" name="land_type" value="ساحلی">
                            <span class="checkmark">ساحلی</span>
                        </label>
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="checkbox" name="land_type" value="داخل بافت">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input type="checkbox" name="land_type" value="خارج بافت">
