...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="../experts/create.php" class="theme-form">

                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label" for="inputPassword3">نام کارشناس</label>
                    <div class="col-sm-9">
                        <input required class="form-control" id="inputnumber" name="name" type="text" placeholder="نام کارشناس">
                    </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input required type="radio" name="is_admin" value="1">
                    ...
                    <div class="col-sm-1 ">
                        <label class="custom-checkbox">
                            <input required type="radio" name="is_admin" value="0">
