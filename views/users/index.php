...
<?php partial('sidebar'); ?>
<?php $users = $queryBuilder->select('*')->from('users')->fetchAllAssociative() ?>
                        ...
                        <tbody>
                            <?php foreach ($users as $user) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="../../users/show.php?id=<?php echo $property['id']; ?>" class="fa fa-eye text-secondray" title="مشاهده"></a>
                                        <a href="../../users/update.php?id=<?php echo $property['id']; ?>" class="fa fa-edit text-primary" title="ویرایش"></a>
