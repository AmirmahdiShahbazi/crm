...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../../assets/js/calendar-jallali/fullcalendar.css">
  <link rel="stylesheet" type="text/css" href="../../assets/js/calendar-jallali/fullcalendar-style.css">
  <!-- Plugins css Ends-->
  <!-- Bootstrap css-->
...
<body>
      ...
      <div class="header-wrapper row m-0">
        ...
        <div class="left-side-header col ps-0 d-none d-md-block">
          <div class="input-group"><span class="input-group-text" id="basic-addon1">
            ...
            <input class="form-control" type="text" placeholder="اینجا جستجو کنید ..." aria-label="search"
            ...
            <li class="cart-nav onhover-dropdown">
              ...
              <div class="cart-dropdown onhover-show-div">
                <div class="dropdown-title">
                  <h3>سبد خرید </h3><a class="f-right" href="cart.html"> <i data-feather="shopping-bag"> </i></a>
                </div>
                <ul class="custom-scrollbar">
                  <li>
                    <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="../../assets/images/banner-1.jpg"
                        alt="">
                      <div class="media-body">
                        <h5> <a href="product.html">پیراهن مشکی با ژاکت</a></h5>
                        <p class="f-w-700">500,000 تومان</p>
                      ...
                      <div class="close-circle"><a href="#"><i class="me-1" data-feather="edit"></i></a><a href="#"><i
                            data-feather="trash-2"></i></a></div>
                    </div>
                  </li>
                  <li>
                    <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="../../assets/images/product-4.png"
                        alt="">
                      <div class="media-body">
                        <h5> <a href="product.html">پیراهن سفید و زرد</a></h5>
                        <p class="f-w-700">500,000 تومان</p>
                        <div class="cart-quantity"> <span class="plus"><i class="fa fa-plus"></i></span>
                          <input class="count" type="text" name="qty" value="3"><span class="minus"><i
                              class="fa fa-minus"></i></span>
                  ...
                  <li>
                    <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="../../assets/images/product-6.jpg"
                        alt="">
                      <div class="media-body">
                        <h5> <a href="product.html">کتونی مشکی نایکی</a></h5>
                        <p class="f-w-700">500,000 تومان</p>
                        <div class="cart-quantity"> <span class="plus"><i class="fa fa-plus"></i></span>
                          <input class="count" type="text" name="qty" value="3"><span class="minus"><i
                              class="fa fa-minus"></i></span>
                  ...
                  <li class="order-total">
                    <h4 class="mb-0 f-w-700">مجموع : <span>1,500,000 ت</span></h4><a
                      class="btn btn-primary view-checkout" href="checkout.html">پرداخت</a>
                  </li>
                </ul>
              </div>
            </li>
                  ...
                  <div class="flip-card-inner">
                          ...
                          <div class="row">
                            <div class="col-4 text-center">
                              <div class="bookmark-content">
                                ...
                                <h5 class="mt-2"> <a href="base-input.html">فرم ها</a></h5>
                              </div>
                            </div>
                            <div class="col-4 text-center">
                              <div class="bookmark-content">
                                <div class="bookmark-icon"><i data-feather="user"></i></div>
                                <h5 class="mt-2"> <a href="user-profile.html">پروفایل</a></h5>
                              </div>
                            </div>
                            <div class="col-4 text-center">
                              <div class="bookmark-content">
                                <div class="bookmark-icon"><i data-feather="server"></i></div>
                                <h5 class="mt-2"> <a href="datatable-basic-init.html">جداول</a></h5>
                              </div>
                            </div>
                          </div>
                        </li>
                        <li class="text-center"><a class="flip-btn btn btn-primary" id="flip-btn"
                            href="javascript:void(0)">افزودن نشانک جدید</a></li>
                      </ul>
                    </div>
                    <div class="back dropdown-title">
                      <ul>
                        ...
                        <li><a class="f-w-700 d-block flip-back" id="flip-back" href="javascript:void(0)">بازگشت</a>
                        </li>
                      </ul>
                    </div>
                  </div>
      ...
      <div class="sidebar-wrapper">
        <div>
          <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light"
                src="../../assets/images/logo/small-logo.png" alt=""><img class="img-fluid for-dark"
            ...
            <div id="sidebar-menu">
              <ul class="sidebar-links" id="simple-bar">
                ...
                <li class="sidebar-list">
                  <label class="badge badge-light-primary">3</label><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                    ...
                    </svg><span class="lan-3">داشبورد</span></a>
                  <ul class="sidebar-submenu">
                    <li><a class="lan-4" href="index.html">پیش فرض</a></li>
                    <li><a class="lan-5" href="dashboard-02.html">فروشگاه</a></li>
                    <li><a href="crypto-dashboard.html">ارز دیجیتال</a></li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    ...
                    </svg><span class="lan-6">ویجت ها</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="general-widget.html">عمومی</a></li>
                    <li><a href="chart-widget.html">نمودار</a></li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                          <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M15.596 11.9365H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M11.1312 8.17725H8.37622" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    </svg><span class="lan-7">لایه صفحه</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="box-layout.html">حالت باکس</a></li>
                    <li><a href="layout-rtl.html">چپ چین</a></li>
                    <li><a href="layout-dark.html">لایه تاریک</a></li>
                    <li><a href="hide-on-scroll.html">نوبار مخفی با اسکرول</a></li>
                    <li><a href="footer-light.html">فوتر روشن</a></li>
                    <li><a href="footer-dark.html">فوتر تاریک</a></li>
                    <li><a href="footer-fixed.html">فوتر ثابت</a></li>
                  </ul>
                </li>
                <li class="sidebar-list">
                  <label class="badge badge-light-info">جدید</label><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                    ...
                    </svg><span>پروژه </span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="projects.html">لیست پروژه ها</a></li>
                    <li><a href="projectcreate.html">ایجاد پروژه جدید</a></li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="file-manager.html">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                          <path d="M7.30566 14.5743H16.8987" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    </svg><span>مدیریت فایل</span></a></li>
                <li class="sidebar-list">
                  <label class="badge badge-light-danger">جدیدترین </label><a
                      ...
                      <g>
                        <g>
                          <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path d="M15.39 14.018L11.999 11.995V7.63403" stroke="#130F26" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round"></path>
                        </g>
                      </g>
                    </svg><span>تابلوی کانبان</span></a>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                  ...
                  <ul class="sidebar-submenu">
                    ...
                    <li><a href="product-page.html">صفحه محصول</a></li>
                    <li><a href="list-products.html">لیست محصولات</a></li>
                    <li><a href="payment-details.html">جزئیات پرداخت</a></li>
                    <li><a href="order-history.html">تاریخچه سفارشات</a></li>
                    <li><a href="invoice-template.html">فاکتور</a></li>
                    <li><a href="cart.html">سبد خرید</a></li>
                    <li><a href="list-wish.html">لیست علاقه مندی</a></li>
                    <li><a href="checkout.html">صفحه پرداخت</a></li>
                    <li><a href="pricing.html">لیست قیمت گذاری</a></li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    ...
                    </svg><span>گفتگو</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="chat.html">اپلیکیشن گفتگو</a></li>
                    <li><a href="chat-video.html">گفتگو ویدئویی</a></li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <g>
                        <g>
                          ...
                          <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path d="M19.1313 8.12891V12.1389" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M21.1776 10.1338H17.0876" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        </g>
                      </g>
                    </svg><span>مخاطبان</span></a></li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="task.html">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                          <path d="M8.44019 12L10.8142 14.373L15.5602 9.62695" stroke="#130F26" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round"></path>
                          <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    </svg><span>وظایف</span></a></li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="calendar-jalali.html">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                          <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path d="M3.02515 9.32397H21.0331" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M16.4284 13.261H16.4374" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M12.0289 13.261H12.0379" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M7.62148 13.261H7.63048" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M16.4284 17.113H16.4374" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M12.0289 17.113H12.0379" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M7.62148 17.113H7.63048" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M16.033 2.05005V5.31205" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M8.02466 2.05005V5.31205" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        </g>
                      </g>
                    </svg><span>تقویم رویداد شمسی</span></a></li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="calendar-basic.html">
                    ...
                    </svg><span>تقویم رویداد میلادی</span></a></li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="social-app.html">
                    ...
                    </svg><span>برنامه شبکه اجتماعی</span></a></li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="to-do.html">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                          <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M21.2498 12C21.2498 17.108 17.1088 21.25 11.9998 21.25C6.89176 21.25 2.74976 17.108 2.74976 12C2.74976 6.891 6.89176 2.75 11.9998 2.75C17.1088 2.75 21.2498 6.891 21.2498 12Z"
                            stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path d="M16.1906 12.7672L11.6606 12.6932V7.84619" stroke="#130F26" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round"></path>
                        </g>
                      </g>
                    </svg><span>لیست To-Do</span></a></li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="search.html">
                    ...
                    </svg><span>وبسایت جستجو </span></a></li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                    ...
                    </svg><span>فرم ها</span></a>
                  <ul class="sidebar-submenu">
                    <li><a class="submenu-title" href="#">کنترل های فرم<span class="sub-arrow"><i
                            class="fa fa-angle-left"></i></span></a>
                      <ul class="nav-sub-childmenu submenu-content">
                        <li><a href="form-validation.html">اعتبارسنجی فرم</a></li>
                        <li><a href="base-input.html">ورودی های پایه</a></li>
                        <li><a href="radio-checkbox-control.html">چک باکس و رادیو</a></li>
                        <li><a href="input-group.html">ورودی های گروهی</a></li>
                        <li><a href="megaoptions.html">گزینه های پیشرفته</a></li>
                      </ul>
                    </li>
                    <li><a class="submenu-title" href="#">ویجت های فرم<span class="sub-arrow"><i
                            class="fa fa-angle-left"></i></span></a>
                      <ul class="nav-sub-childmenu submenu-content">
                        <li><a href="datepicker-sh.html">انتخابگر تاریخ شمسی</a></li>
                        <li><a href="datepicker.html">انتخابگر تاریخ میلادی</a></li>
                        <li><a href="time-picker.html">انتخابگر زمان</a></li>
                        <li><a href="datetimepicker.html">انتخابگر تاریخ و زمان</a></li>
                        <li><a href="daterangepicker.html">انتخابگر محدوده تاریخ</a></li>
                        <li><a href="touchspin.html">تاچ اسپین</a></li>
                        <li><a href="select2.html">انتخاب 2</a></li>
                        <li><a href="switch.html">سوئیچ</a></li>
                        <li><a href="typeahead.html">انتخاب Typeahead</a></li>
                        <li><a href="clipboard.html">کلیپ بورد</a></li>
                      </ul>
                    </li>
                    <li><a class="submenu-title" href="#">لایه فرم<span class="sub-arrow"><i
                            class="fa fa-angle-left"></i></span></a>
                      <ul class="nav-sub-childmenu submenu-content">
                        <li><a href="default-form.html">فرم های پیش فرض</a></li>
                        <li><a href="form-wizard.html">فرم پیشرفته 1</a></li>
                        <li><a href="form-wizard-two.html">فرم پیشرفته 2</a></li>
                        <li><a href="form-wizard-three.html">فرم پیشرفته 3</a></li>
                      </ul>
                    </li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    ...
                    </svg><span>جداول</span></a>
                  <ul class="sidebar-submenu">
                    <li><a class="submenu-title" href="#">جداول بوت استرپ<span class="sub-arrow"><i
                            class="fa fa-angle-left"></i></span></a>
                      <ul class="nav-sub-childmenu submenu-content">
                        <li><a href="bootstrap-basic-table.html">جداول پایه</a></li>
                        <li><a href="bootstrap-sizing-table.html">سایز جداول</a></li>
                        <li><a href="bootstrap-border-table.html">جداول مرزی</a></li>
                        <li><a href="bootstrap-styling-table.html">استایل جداول</a></li>
                        <li><a href="table-components.html">کامپوننت های جدول</a></li>
                      </ul>
                    </li>
                    <li><a class="submenu-title" href="#">جداول داده<span class="sub-arrow"><i
                            class="fa fa-angle-left"></i></span></a>
                      <ul class="nav-sub-childmenu submenu-content">
                        <li><a href="datatable-basic-init.html">پایه</a></li>
                        <li><a href="datatable-advance.html">پیشرفته</a></li>
                        <li><a href="datatable-styling.html">استایل ها</a></li>
                        <li><a href="datatable-AJAX.html">ایجکس</a></li>
                        <li><a href="datatable-server-side.html">سمت سرور</a></li>
                        <li><a href="datatable-plugin.html">پلاگین</a></li>
                        <li><a href="datatable-API.html">ای پی آی</a></li>
                        <li><a href="datatable-data-source.html">منابع داده</a></li>
                      </ul>
                    </li>
                    <li><a class="submenu-title" href="#">افزونه های جداول داده<span class="sub-arrow"><i
                            class="fa fa-angle-left"></i></span></a>
                      <ul class="nav-sub-childmenu submenu-content">
                        <li><a href="datatable-ext-autofill.html">پر کردن خودکار</a></li>
                        <li><a href="datatable-ext-basic-button.html">دکمه پایه</a></li>
                        <li><a href="datatable-ext-col-reorder.html">مرتب سازی ستون</a></li>
                        <li><a href="datatable-ext-fixed-header.html">هدر ثابت</a></li>
                        <li><a href="datatable-ext-html-5-data-export.html">خروجی HTML5</a></li>
                        <li><a href="datatable-ext-key-table.html">کلید جدول</a></li>
                        <li><a href="datatable-ext-responsive.html">ریسپانسیو</a></li>
                        <li><a href="datatable-ext-row-reorder.html">مرتب سازی ردیف</a></li>
                        <li><a href="datatable-ext-scroller.html">قابلیت پیمایش</a></li>
                      </ul>
                    </li>
                    <li><a href="jsgrid-table.html">جدول JsGrid</a></li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                          <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path d="M15.7885 7.56396C16.9955 7.68796 17.7505 8.64496 17.7055 9.98596" stroke="#130F26"
                            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        </g>
                      </g>
                    </svg><span>کامپوننت های Ui</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="state-color.html">رنگ وضعیت</a></li>
                    <li><a href="typography.html">تایپوگرافی</a></li>
                    <li><a href="avatars.html">آواتارها</a></li>
                    <li><a href="helper-classes.html">کلاس های راهنما</a></li>
                    <li><a href="grid.html">شبکه بندی</a></li>
                    <li><a href="tag-pills.html">قرص ها و برچسب ها</a></li>
                    <li><a href="progress-bar.html">نوار پیشرفت</a></li>
                    <li><a href="modal.html">مُدال</a></li>
                    <li><a href="alert.html">هشدار</a></li>
                    <li><a href="popover.html">پاپ آور</a></li>
                    <li><a href="tooltip.html">تولتیپ</a></li>
                    <li><a href="toast.html">تست ها</a></li>
                    <li><a href="loader.html">اسپینر ها</a></li>
                    <li><a href="dropdown.html">فهرست کشویی</a></li>
                    <li><a href="according.html">آکاردئون</a></li>
                    <li><a class="submenu-title" href="#">تب ها<span class="sub-arrow"><i
                            class="fa fa-angle-left"></i></span></a>
                      <ul class="nav-sub-childmenu submenu-content">
                        <li><a href="tab-bootstrap.html">تب های بوت استرپ</a></li>
                        <li><a href="tab-material.html">تب های خطی</a></li>
                      </ul>
                    </li>
                      ...
                      <g>
                        <g>
                          <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M2.75024 12C2.75024 5.063 5.06324 2.75 12.0002 2.75C18.9372 2.75 21.2502 5.063 21.2502 12C21.2502 18.937 18.9372 21.25 12.0002 21.25C5.06324 21.25 2.75024 18.937 2.75024 12Z"
                            stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path d="M9.42993 14.5697L14.5699 9.42969" stroke="#130F26" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round"></path>
                          <path d="M14.4955 14.5H14.5045" stroke="#130F26" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M9.4955 9.5H9.5045" stroke="#130F26" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        </g>
                      </g>
                    </svg><span>کیت های Ui پیشرفته</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="scrollable.html">قابلیت پیمایش</a></li>
                    <li><a href="tree.html">نمایش درختی</a></li>
                    <li><a href="bootstrap-notify.html">اعلان بوت استرپ</a></li>
                    <li><a href="rating.html">رتبه بندی</a></li>
                    <li><a href="dropzone.html">آپلود فایل dropzone</a></li>
                    <li><a href="tour.html">تور</a></li>
                    <li><a href="sweet-alert2.html">هشدار شیرین 2</a></li>
                    <li><a href="modal-animated.html">مُدال انیمیشنی</a></li>
                    <li><a href="owl-carousel.html">اسلایدر کاروسل</a></li>
                    <li><a href="ribbons.html">روبان ها</a></li>
                    <li><a href="pagination.html">صفحه بندی</a></li>
                    <li><a href="breadcrumb.html">مسیر راهنما</a></li>
                    <li><a href="steps.html">گام ها</a></li>
                    <li><a href="range-slider.html">اسلایدر محدوده</a></li>
                    <li><a href="image-cropper.html">برش تصویر</a></li>
                    <li><a href="sticky.html">کامپوننت Sticky</a></li>
                    <li><a href="basic-card.html">کارت پایه</a></li>
                    <li><a href="creative-card.html">کارت خلاقانه</a></li>
                    <li><a href="tabbed-card.html">کارت تب بندی شده</a></li>
                    <li><a href="dragable-card.html">کارت قابل کشیدن</a></li>
                    <li><a class="submenu-title" href="#">تایم لاین<span class="sub-arrow"><i
                            class="fa fa-angle-left"></i></span></a>
                      <ul class="nav-sub-childmenu submenu-content">
                        <li><a href="timeline-v-1.html">تایم لاین 1</a></li>
                        <li><a href="timeline-v-2.html">تایم لاین 2</a></li>
                      </ul>
                    </li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                          <path d="M13.3352 19.5078H19.7122" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path d="M10.5042 7.21143L15.3682 10.8624" stroke="#130F26" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round"></path>
                        </g>
                      </g>
                    </svg><span>سازنده</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="form-builder-1.html"> فرم ساز 1</a></li>
                    <li><a href="form-builder-2.html"> فرم ساز 2</a></li>
                    <li><a href="pagebuild.html">صفحه ساز</a></li>
                    <li><a href="button-builder.html">دکمه ساز</a></li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    </svg><span>انیمیشن</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="animate.html">انیمیشن</a></li>
                    <li><a href="scroll-reval.html">ریوال اسکرول</a></li>
                    <li><a href="AOS.html">انیمیشن AOS</a></li>
                    <li><a href="tilt.html">انیمیشن عنوان</a></li>
                    <li><a href="wow.html">انیمیشن Wow</a></li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                          <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path d="M15.9935 12H16.0025" stroke="#130F26" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M11.9945 12H12.0035" stroke="#130F26" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M7.9955 12H8.0045" stroke="#130F26" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        </g>
                      </g>
                    </svg><span>آیکون ها</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="flag-icon.html">آیکون پرچم</a></li>
                    <li><a href="font-awesome.html">آیکون فونت آوسوم</a></li>
                    <li><a href="ico-icon.html">آیکون Ico</a></li>
                    <li><a href="themify-icon.html">آیکون themify</a></li>
                    <li><a href="feather-icon.html">آیکون Feather</a></li>
                    <li><a href="whether-icon.html">آیکون Whether</a></li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="buttons.html">
                    ...
                    </svg><span>دکمه ها</span></a></li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                          <path d="M7.4831 10.261V16.9547" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M12.0368 7.05737V16.9553" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M16.5158 13.7983V16.9552" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    </svg><span>نمودار ها</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="chart-apex.html">نمودار Apex</a></li>
                    <li><a href="chart-google.html">نمودار Google</a></li>
                    <li><a href="chart-sparkline.html">نمودار Sparkline</a></li>
                    <li><a href="chart-flot.html">نمودار Flot</a></li>
                    <li><a href="chart-knob.html">نمودار Knob</a></li>
                    <li><a href="chart-morris.html">نمودار Morris</a></li>
                    <li><a href="chartjs.html">نمودار Chatjs</a></li>
                    <li><a href="chartist.html">نمودار Chartist</a></li>
                    <li><a href="chart-peity.html">نمودار Peity</a></li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="sample-page.html">
                    ...
                    </svg><span>صفحه ساده</span></a></li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                    href="internationalization.html">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                          <path d="M11.879 14.791V2.75" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M14.795 11.8643L11.879 14.7923L8.96301 11.8643" stroke="#130F26" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round"></path>
                          <path
                    ...
                    </svg><span>بین المللی شدن</span></a></li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="../starter-kit/index-kit.html"
                    target="_blank">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                          <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path d="M13.9341 2.83276V5.49376C13.9341 7.35176 15.4401 8.85676 17.2981 8.85676H20.2491"
                            stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path d="M14.3125 12.9807H9.41248" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M11.8633 15.4308V10.5308" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        </g>
                      </g>
                    </svg><span>کیت شروع</span></a></li>
                        ...
                        <div class="col mega-box">
                          <div class="link-section">
                            ...
                            <ul class="submenu-content opensubmegamenu">
                              <li><a href="error-page1.html" target="_blank">صفحه خطا 1</a></li>
                              <li><a href="error-page2.html" target="_blank">صفحه خطا 2</a></li>
                              <li><a href="error-page3.html" target="_blank">صفحه خطا 3</a></li>
                              <li><a href="error-page4.html" target="_blank">صفحه خطا 4</a></li>
                            </ul>
                          </div>
                        </div>
                        <div class="col mega-box">
                          <div class="link-section">
                            ...
                            <ul class="submenu-content opensubmegamenu">
                              <li><a href="login.html" target="_blank">ورود ساده</a></li>
                              <li><a href="login_one.html" target="_blank">ورود با پس زمینه تصویر</a></li>
                              <li><a href="login_two.html" target="_blank">ورود با تصویر 2</a></li>
                              <li><a href="login-bs-validation.html" target="_blank">ورود با اعتبارسنجی</a></li>
                              <li><a href="login-bs-tt-validation.html" target="_blank">ورود با تولتیپ</a></li>
                              <li><a href="login-sa-validation.html" target="_blank">ورود با هشدار</a></li>
                              <li><a href="sign-up.html" target="_blank">ثبت نام ساده</a></li>
                              <li><a href="sign-up-one.html" target="_blank">ثبت نام با پس زمینه تصویر</a></li>
                              <li><a href="sign-up-two.html" target="_blank">ثبت نام با پس زمینه ویدئو</a></li>
                              <li><a href="unlock.html">باز شدن قفل</a></li>
                              <li><a href="forget-password.html">فراموشی رمز عبور</a></li>
                              <li><a href="creat-password.html">ایجاد رمز عبور</a></li>
                              <li><a href="maintenance.html">در دست تعمیر</a></li>
                            </ul>
                          </div>
                        </div>
                        <div class="col mega-box">
                          <div class="link-section">
                            ...
                            <ul class="submenu-content opensubmegamenu">
                              <li><a href="comingsoon.html">به زودی ساده</a></li>
                              <li><a href="comingsoon-bg-img.html">به زودی با پس زمینه تصویر</a></li>
                            </ul>
                          </div>
                        </div>
                        <div class="col mega-box">
                          <div class="link-section">
                            ...
                            <ul class="submenu-content opensubmegamenu">
                              <li><a href="basic-template.html">ایمیل پایه</a></li>
                              <li><a href="email-header.html">ایمیل پایه با هدر</a></li>
                              <li><a href="template-email-2.html">قالب ایمیل 2</a></li>
                              <li><a href="ecommerce-templates.html">ایمیل فروشگاهی</a></li>
                              <li><a href="email-order-success.html">سفارش موفق</a></li>
                            </ul>
                          </div>
                        </div>
                      </div>
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                  ...
                  <ul class="sidebar-submenu">
                    <li><a href="gallery.html">شبکه بندی گالری</a></li>
                    <li><a href="gallery-with-description.html">شبکه بندی گالری با توضیحات</a></li>
                    <li><a href="gallery-masonry.html">گالری ماسونری</a></li>
                    <li><a href="masonry-gallery-with-disc.html">گالری ماسونری با توضیحات</a></li>
                    <li><a href="gallery-hover.html">افکت های هاور</a></li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    </svg><span>اخبار</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="blog.html">اخبار</a></li>
                    <li><a href="blog-single.html">جزئیات خبر</a></li>
                    <li><a href="add-post.html">افزودن پست</a></li>
                  </ul>
                </li>
                      ...
                      <g>
                        <g>
                          <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path d="M12.0002 15.895V12" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M12.0045 8.5H11.9955" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        </g>
                      </g>
                    </svg><span>سوالات متداول</span></a></li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                          <path
                            ...
                            stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path d="M17.7219 12.0531H17.4248" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M7.6062 8.14367H11.6662" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    </svg><span>جستجو شغل</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="job-cards-view.html">نمایش کارت</a></li>
                    <li><a href="job-list-view.html">نمایش لیست</a></li>
                    <li><a href="job-details.html">جزئیات شغل</a></li>
                    <li><a href="job-apply.html">تایید</a></li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                          <path d="M11.0791 13.8496H7.4314" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M15.4774 12.1712H15.3752" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path d="M17.2081 15.5833H17.1059" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                          <path
                            d="M8.51392 2.21606C8.5206 2.93015 9.1058 3.50295 9.81989 3.49626H10.828C11.9306 3.48767 12.8328 4.37169 12.8481 5.47432V6.48148"
                            stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M21.8121 13.8953C21.8121 8.33539 19.4255 6.48145 12.2646 6.48145C5.10271 6.48145 2.71606 8.33539 2.71606 13.8953C2.71606 19.4562 5.10271 21.3092 12.2646 21.3092C19.4255 21.3092 21.8121 19.4562 21.8121 13.8953Z"
                            stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        </g>
                      </g>
                    </svg><span>یادگیری</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="learning-list-view.html">لیست یادگیری</a></li>
                    <li><a href="learning-detailed.html">جزئیات دوره</a></li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    </svg><span>نقشه ها</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="map-js.html">نقشه های JS</a></li>
                    <li><a href="vector-map.html">نقشه های وکتور</a></li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                          ...
                          <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path d="M15.009 5.80078L18.604 8.98378" stroke="#130F26" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round"></path>
                        </g>
                      </g>
                    </svg><span>ویرایشگر ها</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="summernote.html">ویرایشگر متن SummerNote</a></li>
                    <li><a href="ckeditor.html">ویرایشگر متن CKeditor</a></li>
                    <li><a href="simple-MDE.html">ویرایشگر متن simpleMDE</a></li>
                    <li><a href="ace-code-editor.html">ویرایشگر کد ACE</a></li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                          <path d="M6.91699 14.854L9.90999 10.965L13.324 13.645L16.253 9.86499" stroke="#130F26"
                            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    </svg><span>دانش محور</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="knowledgebase.html">دانش محور</a></li>
                    <li><a href="knowledge-category.html">دسته بندی دانش</a></li>
                    <li><a href="knowledge-detail.html">جزئیات دانش</a></li>
                  </ul>
                </li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="support-ticket.html">
                    ...
                    </svg><span>تیکت پشتیبانی</span></a></li>
              </ul>
            </div>
          ...
          <div class="page-title">
            <div class="row">
              <div class="col-12 col-sm-6">
                <h3>تقویم رویداد شمسی</h3>
              </div>
              <div class="col-12 col-sm-6">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="index.html"> <i data-feather="home"></i></a></li>
                  <li class="breadcrumb-item">تقویم</li>
                  <li class="breadcrumb-item active">تقویم رویداد شمسی</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div class="box no-border no-shadow">
                ...
                <div class="box-body p-0">
                  ...
                  <div id='external-events'>
                    <p>برای ثبت رویداد جدید، رویداد های زیر را کشیده و در قسمت مورد
                      نظر رها کنید یا
                      روی روز مورد نظر کلیک کنید</p>
  ...
  <!-- latest jquery-->
  <script src="../../assets/js/calendar-jallali/jquery.js"></script>
  <!-- Bootstrap js-->
  ...
  <script src="../../assets/js/calendar-jallali/jquery-ui.min.js"></script>
  <script src="../../assets/js/calendar-jallali/moment.min.js"></script>
  <script src="../../assets/js/calendar-jallali/moment-jalaali.js"></script>
  <script src="../../assets/js/calendar-jallali/fullcalendar.min.js"></script>
  <script src="../../assets/js/calendar-jallali/fa.js"></script>
  <!-- Plugins JS Ends-->
  <!-- Theme js-->
    ...
    $(document).ready(function () {
      ...
      $('#calendar2').fullCalendar({
        ...
        if (title) {
          ...
          // Add the reminder to the backend
          addReminder(title, type , start, end);
        }
        $('#calendar2').fullCalendar('unselect');
      },
      eventClick: function (event) {
            // Display reminder details when clicking on an event
        ...
        //     id: 999,
        //     title: 'رویداد تکراری',
        //     start: '2021-03-29T16:00:00'
        //   },
        //   {
        //     id: 999,
        //     title: 'رویداد تکراری',
        //     start: '2021-04-27T16:00:00'
        //   },
        //   {
        //     title: 'کنفرانس',
        //     start: '2021-05-02',
        ...
        //   {
        //     title: 'جلسه',
        //     start: '2021-11-26T10:30:00',
        //     end: '2021-04-24T12:30:00'
        //   },
        //   {
        //     title: 'ناهار',
        ...
        //   {
        //     title: 'جلسه',
        //     start: '2021-05-22T14:30:00'
        //   },
        //   {
        //     title: 'تایم استراحت',
        //     start: '2021-04-22T17:30:00'
        //   },
        //   {
        //     title: 'شام',
...
function addReminder(title, type, start, end) {
  ...
  $.ajax({
    ...
    data: {
      title: title,
      start: start.format(), // Format the date for the backend
      end: end.format(), // Format the date for the backend
      type: type
    },
    success: function (response) {
      // Handle success, maybe update the calendar if needed
      console.log('Reminder added successfully:', response);
      // Uncomment the following line to update the calendar if needed
      fetchReminders();
    },
...
function fetchReminders() {
  $.ajax({
    type: 'GET',
    url: 'reminder/getReminders.php', // Update the path to your backend script
