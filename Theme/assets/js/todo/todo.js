! function (e) {
    e(document).ready(function () {
        ...
        e(".add-task-btn").click(function () {
            ...
            var s = e(this).closest(".task"),
                t = s.find(".task-label").text(),
                l = s.hasClass("completed") ? "علامت گذاری کامل" : "علامت گذاری ناقص";
            e(this).attr("title", l), s.hasClass("completed") ? a(t, "به عنوان ناقص علامت گذاری شده است.") : a(t, " به عنوان کامل علامت گذاری شده است.", "success"), s.toggleClass("completed")
            ...
            e("#todo-list .task").addClass("completed"), e("#mark-all-incomplete").removeClass("move-down"), e(this).addClass("move-up"), a("همه وظایف", "به عنوان کامل علامت گذاری شده است.", "success")
        }), e("#mark-all-incomplete").click(function () {
            e("#todo-list .task").removeClass("completed"), e(this).addClass("move-down"), e("#mark-all-finished").removeClass("move-up"), a("همه وظایف", "به عنوان ناقص علامت گذاری شده است.")
        })
    })
}(jQuery);