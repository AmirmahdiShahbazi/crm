function submitContact() {
	if ($("#bookmark-form").valid()) {
		                ...
		                <div class="profile-mail">\
		                  ...
		                  <img class="img-100 img-fluid m-r-20 rounded-circle update_img_0" src="../assets/images/user/user.png" alt="" data-original-title="" title="">\
		                    ...
		                    <div class="media-body mt-0">\
		                      ...
		                      <p class="email_add_'+index_var+'">'+mail+'</p>\
		                      <ul>\
		                        <li><a href="#" onclick="editContact('+index_var+')" data-original-title="" title="">ویرایش</a></li>\
		                        <li><a href="#" onclick="deleteContact('+index_var+')" data-original-title="" title="">حذف</a></li>\
		                        <li><a href="#" onclick="history('+index_var+')" data-original-title="" title="">تاریخچه</a></li>\
		                        <li><a href="#" onclick="printContact('+index_var+')" data-toggle="modal" data-target="#printModal" data-original-title="" title="">چاپ</a></li>\
		                      </ul>\
		                    </div>\
		                  </div>\
		                  <div class="email-general">\
		                    <h6>عمومی</h6>\
		                    <p>آدرس ایمیل : <span class="font-primary email_add_'+index_var+'">'+mail+'</span></p>\
		                  </div>\
		    			</div>';
	    ...
	    var notify = $.notify('مخاطب با موفقیت اضافه شد', {
		    type: 'contactadd',
		    allow_dismiss: false,
		    delay: 2000,
		    placement: {
...
function deleteContact(index){
	swal({
            ...
            text: "این مخاطب از لیت مخاطبین شما حذف خواهد شد!",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
