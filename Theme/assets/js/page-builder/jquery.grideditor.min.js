! function(a) {
        ...
        return c.each(function(c, d) {
            function e() {
                ...
                C = a('<div class="ge-addRowGroup btn-group" />').appendTo(b), a.each(E.new_row_layouts, function(b, c) {
                    var d = a('<a class="btn-sm btn-grid btn-square btn-grid p-10" />').attr("title", "افزودن ردیف " + c.join("-")).on("click", function() {
                        var a = r().appendTo(A);
                        c.forEach(function(b) {
                            s(b).appendTo(a)
                        }), f()
                    }).appendTo(C);
                    d.append('<span class="fa fa-plus-circle"><span class="circle-title">'+c.join("-")+' &nbsp;&nbsp;</span></span>');
                    var e = (c.join(" - "), '<div class="row ge-row-icon">');
                    c.forEach(function(a) {
                        e += '<div class="column col-' + a + '"/>'
                    }), e += "</div>",  d.append(e)
                });
                var e = a('<div class="btn-group float-start float-xl-end"/>').appendTo(b),
                    h = a('<button title="کد منبع را ویرایش کنید" type="button" class="btn-code gm-edit-mode"><span class="fa fa-chevron-right"></span><span class="fa fa-chevron-left"></span></button>').on("click", function() {
                    ...
                    i = a('<button title="پیش نمایش" type="button" class="btn-code gm-preview m-r-5"><span class="fa fa-eye"></span></button>').on("mouseenter", function() {
                    ...
                    c = a('<div class="dropdown float-start float-xl-end ge-layout-mode"><button type="button" class="btn-screen dropdown-toggle" data-bs-toggle="dropdown"><span class="me-2">دسکتاپ</span></button><ul class="dropdown-menu" role="menu"><li><a data-width="auto" title="دسکتاپ" class="dropdown-item"><span>دسکتاپ</span></a></li><li><a title="تبلت" class="dropdown-item"><span>تبلت</span></li><li><a title="گوشی همراه" class="dropdown-item"><span>گوشی همراه</span></a></li></ul></div>').on("click", "a", function() {
                        var b = a(this);
            ...
            function h() {
                A.find(".row").each(function() {
                    ...
                    if (!b.find("> .ge-tools-drawer").length) {
                        ...
                        j(c, "حرکت", "ge-move", "fa-arrows"), j(c, "تنظیمات", "", "fa-cog", function() {
                            d.toggle()
                        }), E.row_tools.forEach(function(a) {
                            j(c, a.title || "", a.className || "", a.iconClass || "fa-wrench", a.on)
                        }), j(c, "حذف ردیف", "", "fa-trash", function() {
                            window.confirm("حذف ردیف؟") && b.slideUp(function() {
                                b.remove()
                            })
                        }), j(c, "افزودن ستون", "ge-add-column", "fa-plus-circle", function() {
                            b.append(s(3)), f()
                        });
            ...
            function i() {
                A.find(".column").each(function() {
                    ...
                    if (!b.find("> .ge-tools-drawer").length) {
                        var c = a('<div class="ge-tools-drawer" />').prependTo(b);
                        j(c, "حرکت", "ge-move", "fa-arrows"), j(c, "ستون را باریکتر کنید\n(شیفت را برای حداقل نگه دارید)", "ge-decrease-col-width", "fa-minus", function(a) {
                            var c = E.valid_col_sizes,
                                d = F[G],
                                e = c.indexOf(m(b, d)),
                                f = c[z(e - 1, 0, c.length - 1)];
                            a.shiftKey && (f = c[0]), o(b, d, Math.max(f, 1))
                        }), j(c, "ستون را گسترده تر کنید\n(شیفت را برای حداکثر نگه دارید)", "ge-increase-col-width", "fa-plus", function(a) {
                            var c = E.valid_col_sizes,
                                d = F[G],
                                e = c.indexOf(m(b, d)),
                        ...
                        }), j(c, "تنظیمات", "", "fa-cog", function() {
                            d.toggle()
                        }), E.col_tools.forEach(function(a) {
                            j(c, a.title || "", a.className || "", a.iconClass || "fa-wrench", a.on)
                        }), j(c, "حذف ستون", "", "fa-trash", function() {
                        ...
                        }), j(c, "افزودن ردیف", "ge-add-row", "fa-plus-circle", function() {
                            var a = r();
    ...
    function() {
        $.fn.gridEditor.RTEs.ckeditor = {
            ...
            initialContent: "<p>لورم ایپسوم ... </p>"
        }
    }(),
    function() {
