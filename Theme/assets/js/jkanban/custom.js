  ...
  boards: [
    {
      ...
      item: [
        {
          title: `
                               <a class="kanban-box" href="#"><span class="date">1401/07/23</span><span class="badge badge-primary f-right">متوسط</span>
                                <h6>طراحی داشبورد</h6>
        ...
        {
          title: `
                               <a class="kanban-box" href="#"><span class="date">1401/07/24</span><span class="badge badge-danger f-right">فوری</span>
                                <h6>تست سایدبار</h6>
                                <div class="media"><img class="img-20 me-1 rounded-circle" src="../assets/images/user/3.jpg" alt="" data-original-title="" title="">
                                  <div class="media-body">
                                    <p>راست چین، ایران</p>
    ...
    },
    {
      ...
      item: [
        ...
        {
          title: `
                               <a class="kanban-box" href="#"><span class="date">1401/07/24</span><span class="badge badge-success f-right">کم</span>
                                <h6>مشکل داشبورد</h6>
                                <div class="media"><img class="img-20 me-1 rounded-circle" src="../assets/images/user/3.jpg" alt="" data-original-title="" title="">
                                  <div class="media-body">
                                    <p>راست چین، ایران</p>
...
var kanban2 = new jKanban({
  ...
  boards: [
    {
      id: "_todo",
      title: "لیست انجام (آیتم فقط در حال کار است)",
      class: "bg-info",
      dragTo: ["_working"],
      item: [
        {
          title: `
                               <a class="kanban-box" href="#"><span class="date">1401/07/24</span><span class="badge badge-info f-right">متوسط</span>
                                <h6>تست سایدبار</h6>
                                <div class="media"><img class="img-20 me-1 rounded-circle" src="../assets/images/user/3.jpg" alt="" data-original-title="" title="">
                                  <div class="media-body">
                                    <p>راست چین، ایران</p>
    ...
    {
      id: "_done",
      title: "انجام شده (آیتم فقط در حال کار است)",
      class: "bg-success",
      dragTo: ["_working"],
      item: [
        {
