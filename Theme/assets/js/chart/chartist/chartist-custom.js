(function($) {
	...
	var chart = new Chartist.Line('.ct-7', {
	  	labels: ['دو', 'سه', 'چهار', 'پنج', 'جمعه', 'شنبه'],
	  	series: [
			[1, 5, 2, 5, 4, 3],
			[2, 3, 4, 8, 1, 2],
			[5, 4, 3, 2, 1, 0.5]
	...
	var data = {
	  	labels: ['م1', 'م2', 'م3', 'م4', 'م5', 'م6', 'م7', 'م8', 'م9', 'م10'],
	  	series: [
			[1, 2, 4, 8, 6, -2, -1, -4, -6, -2]
	  	]
	};
	...
	new Chartist.Bar('.ct-10', {
	  	labels: ['م1', 'م2', 'م3', 'م4', 'م5', 'م6', 'م7', 'م8', 'م9', 'م10', 'م11', 'م12', 'م13'],
	  	series: [
	...
	new Chartist.Bar('.ct-12', {
	  	labels: ['1393-11', '1394-12', '1395-13', '1396-13', '1397-15', '1398-16', '1399-17', '1400-18'],
	  	series: [
