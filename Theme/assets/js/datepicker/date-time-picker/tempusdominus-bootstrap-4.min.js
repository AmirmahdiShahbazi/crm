    ...
    var d = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (a) {
        ...
        f = function (a) {
            var b = "datetimepicker",
                ...
                t = function () {
                    function h(a, b) {
                        c(this, h), this._options = this._getOptions(b), this._element = a, this._dates = [], this._datesFormatted = [], this._viewDate = null, this.unset = !0, this.component = !1, this.widget = !1, this.use24Hours = null, this.actualFormat = null, this.parseFormats = null, this.currentViewMode = null, this._int()
                    }
                    return h.prototype._int = function () {
                        ...
                        return void 0 !== window.moment.tz && void 0 !== this._options.timeZone && null !== this._options.timeZone && "" !== this._options.timeZone
                        ...
                        a.type === h.Event.CHANGE && a.date && a.date.isSame(a.oldDate) || !a.date && !a.oldDate || this._element.trigger(a)
                        ...
                        return void 0 === this._options.parseInputDate ? window.moment.isMoment(a) || (a = this.getMoment(a)) : a = this._options.parseInputDate(a), a
                        ...
                        var b = void 0;
                        return b = void 0 === a || null === a ? window.moment() : this._hasTimeZone() ? window.moment.tz(a, this.parseFormats, this._options.useStrict, this._options.timeZone) : window.moment(a, this.parseFormats, this._options.useStrict), this._hasTimeZone() && b.tz(this._options.timeZone), b
                        ...
                        if (b = b || 0, 0 === arguments.length) return this.unset ? null : this._options.allowMultidate ? this._dates.join(this._options.multidateSeparator) : this._dates[b].clone();
                        if (!(null === a || "string" == typeof a || window.moment.isMoment(a) || a instanceof Date)) throw new TypeError("date() parameter must be one of [null, string, moment or Date]");
                        ...
                        if (!window.moment.localeData(a)) throw new TypeError("locale() locale " + a + " is not loaded from moment locales!");
                        for (var b = 0; b < this._dates.length; b++) this._dates[b].locale(this._options.locale);
                        ...
                        if (h.ViewModes.indexOf(a) === -1) throw new TypeError("viewMode() parameter must be one of (" + h.ViewModes.join(", ") + ") value");
                        this._options.viewMode = a, this.currentViewMode = Math.max(h.ViewModes.indexOf(a) - 1, h.MinViewModeNumber), this._showMode()
                        ...
                        if (!("string" == typeof a || window.moment.isMoment(a) || a instanceof Date)) throw new TypeError("viewDate() parameter must be one of [string, moment or Date]");
        ...
        var g = e.fn[f.NAME],
            ...
            l = function (g) {
                ...
                return b(k, g), k.prototype._init = function () {
                    ...
                    var a = e("<div>").addClass("bootstrap-datetimepicker-widget dropdown-menu show"),
